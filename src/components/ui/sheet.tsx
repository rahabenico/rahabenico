  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        data-side={side}
        className={cn(
          "data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 bg-background ring-foreground/10 fixed z-50 gap-4 p-6 ring-1 duration-100",
          side === "top" && "data-closed:slide-out-to-top data-open:slide-in-from-top inset-x-0 top-0 border-b",
          side === "bottom" && "data-closed:slide-out-to-bottom data-open:slide-in-from-bottom inset-x-0 bottom-0 border-t",
